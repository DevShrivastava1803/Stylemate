...
// Simplified icons to avoid external dependency issues in this specific output format, 
// ensuring a standalone copy-paste experience.
...
export const ShirtIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M20.38 3.4a2 2 0 0 0-1.2-1.1 1.99 1.99 0 0 0-1.8.4L12 6 6.62 2.7a2 2 0 0 0-1.8-.4 2 2 0 0 0-1.2 1.1L2 9l5 2v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2v-9l5-2z" />
  </svg>
);
